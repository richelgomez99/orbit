...
5. Land ContactRef schema only with the Room migration and tests.
...
- Do not add ContactRef entity fields without the matching Room migration.
...
- Follow-on slice: additive ContactRef schema migration.
