...
- Spec 010 artifacts were regenerated on 2026-06-12. The implementation path is product surface and deterministic local coordinator first, then optional model-assisted planning behind existing cloud/local controls. AppFunctions/Spark interop, A2UI, durable chat sessions, and BYOM local model manager remain deferred.
