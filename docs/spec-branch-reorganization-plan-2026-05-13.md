...
| --- | --- | ---: | --- |
| `/Users/richelgomez/dev/orbit` | `qa/015-017-stacked` | 14 untracked docs | Current integration/docs workspace. Planning docs are not committed. |
| `/Users/richelgomez/dev/orbit-015-phase1-split` | `015-phase1-cluster-surface` | Clean after `275ead9` | Actual `015` implementation branch pushed as PR #21. |
| `/Users/richelgomez/dev/orbit-spec-016` | `016-intent-set-migration` | clean | Implementation branch is clean but diverged from stale PR branch. |
| `/Users/richelgomez/dev/orbit-spec-017` | `017-capture-feedback-actions` | clean after PR update | Actual `017` implementation branch is represented by PR #20 at `1d0d100`. |
| `/Users/richelgomez/dev/orbit-visual-refit` | `015-visual-refit` | clean | Old planning branch, not the current implementation split. |
| `/Users/richelgomez/dev/orbit-015-p0c1` | `main` | clean, ahead/behind origin | Do not use as a fresh base until reconciled with `origin/main`. |
...
- Run standard Android gate in `/Users/richelgomez/dev/orbit-spec-016`.
...
- Run standard Android gate in `/Users/richelgomez/dev/orbit-spec-017`.
...
- Run standard Android gate in `/Users/richelgomez/dev/orbit-015-phase1-split`.
