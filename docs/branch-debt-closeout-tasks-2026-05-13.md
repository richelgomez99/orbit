...
**Repository**: `/Users/richelgomez/dev/orbit`

**Current integration/reference worktree**: `/Users/richelgomez/dev/orbit` on `qa/015-017-stacked`
...
- Do not discard, reset, or clean staged changes in sibling worktrees. The staged changes in `/Users/richelgomez/dev/orbit-015-phase1-split` and `/Users/richelgomez/dev/orbit-spec-017` are presumed to be intentional work until the owner says otherwise.
...
| --- | --- | --- |
| Integration docs | `/Users/richelgomez/dev/orbit` on `qa/015-017-stacked` | Reference workspace with untracked planning docs; no app implementation work here. |
| 016 | `/Users/richelgomez/dev/orbit-spec-016` on `016-intent-set-migration` | Clean locally, but stale/diverged relative to PR #8 branch. |
| 017 | `/Users/richelgomez/dev/orbit-spec-017` on `017-capture-feedback-actions` | Actual implementation PR #20; review fixes pushed at `1d0d100`. |
| 015 | `/Users/richelgomez/dev/orbit-015-phase1-split` on `015-phase1-cluster-surface` | Actual implementation PR #21; closeout commit `275ead9` pushed. |
| Stale 015 PR | `/Users/richelgomez/dev/orbit-visual-refit` on `015-visual-refit` | Historical planning branch behind PR #5; closed as superseded by PR #21. |
...
```bash
git -C /Users/richelgomez/dev/orbit status --short
git -C /Users/richelgomez/dev/orbit worktree list
git -C /Users/richelgomez/dev/orbit branch -vv
git -C /Users/richelgomez/dev/orbit-015-phase1-split status --short
git -C /Users/richelgomez/dev/orbit-015-phase1-split diff --staged --stat
git -C /Users/richelgomez/dev/orbit-spec-016 status --short
git -C /Users/richelgomez/dev/orbit-spec-016 branch -vv
git -C /Users/richelgomez/dev/orbit-spec-017 status --short
git -C /Users/richelgomez/dev/orbit-spec-017 diff --staged --stat
```
...
**Integration/reference worktree**: `/Users/richelgomez/dev/orbit` on `qa/015-017-stacked` at `450183f452e71aa70cc3ebf1e31c8bddd7760ef4`. The branch has no upstream in `git branch -vv`. Current dirty state is untracked docs only:
...
| Path | Branch | Head |
| --- | --- | --- |
| `/Users/richelgomez/dev/orbit` | `qa/015-017-stacked` | `450183f452e71aa70cc3ebf1e31c8bddd7760ef4` |
| `/Users/richelgomez/dev/orbit-015-p0c1` | `main` | `93be2d75758e5630ee402afee79176697f18dd62` |
| `/Users/richelgomez/dev/orbit-015-phase1-split` | `015-phase1-cluster-surface` | `275ead90c64a8fcaaa66d804774d3ba32a11abbe` |
| `/Users/richelgomez/dev/orbit-spec-016` | `016-intent-set-migration` | `96ac77dcfa74fbe5b0f86ec83bbdb6da44c5ad00` |
| `/Users/richelgomez/dev/orbit-spec-017` | `017-capture-feedback-actions` | `ceca6e65cb9ab4974e1cd1992e4f19ed37e03138` |
| `/Users/richelgomez/dev/orbit-visual-refit` | `015-visual-refit` | `d9d5db01957cdfc846734c3af8e9178284013317` |
...
**016 worktree**: `/Users/richelgomez/dev/orbit-spec-016` is clean. It is ahead 11 / behind 3 relative to `origin/016-intent-set-migration`, and `git rev-list --left-right --count origin/main...HEAD` reports `0 5` relative to `origin/main`.

**017 staged files**: `/Users/richelgomez/dev/orbit-spec-017` has 6 staged modified files and no unstaged output from the read-only check:
...
**015 staged files**: `/Users/richelgomez/dev/orbit-015-phase1-split` has 21 staged files and no unstaged output from the read-only check:
...
- [x] T001 Record `qa/015-017-stacked` status, untracked docs, branch head, and upstream state in [docs/branch-debt-closeout-tasks-2026-05-13.md](branch-debt-closeout-tasks-2026-05-13.md) using `git -C /Users/richelgomez/dev/orbit status --short` and `git -C /Users/richelgomez/dev/orbit branch -vv`.
- [x] T002 [P] Record all active worktrees in [docs/branch-debt-closeout-tasks-2026-05-13.md](branch-debt-closeout-tasks-2026-05-13.md) using `git -C /Users/richelgomez/dev/orbit worktree list`.
...
- [x] T004 [P] Capture the staged file list and diff stat for `/Users/richelgomez/dev/orbit-015-phase1-split` in [docs/branch-debt-closeout-tasks-2026-05-13.md](branch-debt-closeout-tasks-2026-05-13.md) without unstaging or discarding any file.
- [x] T005 [P] Capture the staged file list and diff stat for `/Users/richelgomez/dev/orbit-spec-017` in [docs/branch-debt-closeout-tasks-2026-05-13.md](branch-debt-closeout-tasks-2026-05-13.md) without unstaging or discarding any file.
- [x] T006 [P] Confirm `/Users/richelgomez/dev/orbit-spec-016` is clean and record its ahead/behind relationship to `origin/main` and its remote PR branch in [docs/branch-debt-closeout-tasks-2026-05-13.md](branch-debt-closeout-tasks-2026-05-13.md).
...
- [x] T010 Preserve the current untracked planning docs from `/Users/richelgomez/dev/orbit/docs` by listing their filenames in [docs/branch-debt-closeout-tasks-2026-05-13.md](branch-debt-closeout-tasks-2026-05-13.md); do not move them until Phase 5.
...
**Independent Test**: `016` can be reviewed and landed from `/Users/richelgomez/dev/orbit-spec-016` with no ContactRef schema work, no stale rename behavior, and Android/cloud classifier gates passing.

### Phase 2 Snapshot - 2026-05-13

Recorded from `/Users/richelgomez/dev/orbit-spec-016`.
...
- [x] T011 Confirm `/Users/richelgomez/dev/orbit-spec-016` is clean before reconciliation using `git -C /Users/richelgomez/dev/orbit-spec-016 status --short` and record the result in [specs/016-intent-set-migration/tasks.md](../specs/016-intent-set-migration/tasks.md).
- [x] T012 [P] Compare local `016-intent-set-migration` against `origin/main` from `/Users/richelgomez/dev/orbit-spec-016` using `git diff --stat origin/main...HEAD` and record the summary in [specs/016-intent-set-migration/tasks.md](../specs/016-intent-set-migration/tasks.md).
- [x] T013 [P] Compare local `016-intent-set-migration` against stale PR #8 branch from `/Users/richelgomez/dev/orbit-spec-016` and record whether PR #8 should be updated or replaced in [docs/branch-debt-closeout-tasks-2026-05-13.md](branch-debt-closeout-tasks-2026-05-13.md).
- [x] T014 Run the Android gate in `/Users/richelgomez/dev/orbit-spec-016`: `ANDROID_HOME="$HOME/Library/Android/sdk" JAVA_HOME='/Applications/Android Studio.app/Contents/jbr/Contents/Home' ./gradlew :app:compileDebugKotlin :app:testDebugUnitTest :app:compileDebugAndroidTestKotlin :app:lintDebug`, then record results in [specs/016-intent-set-migration/tasks.md](../specs/016-intent-set-migration/tasks.md).
- [x] T015 Run the Supabase classifier gate in `/Users/richelgomez/dev/orbit-spec-016/supabase/functions/llm_gateway`: `npm run typecheck` and `npm run test:unit`, then record results in [specs/016-intent-set-migration/tasks.md](../specs/016-intent-set-migration/tasks.md).
- [x] T016 Run stale-label search in `/Users/richelgomez/dev/orbit-spec-016`: `rg -n "REMIND_ME|INSPIRATION|intent-set rename" app/src/main supabase/functions/llm_gateway`, then record expected no-implementation-hit results in [specs/016-intent-set-migration/quickstart.md](../specs/016-intent-set-migration/quickstart.md).
- [x] T017 Run intent-label coverage search in `/Users/richelgomez/dev/orbit-spec-016`: `rg -n "Intent\.READ_LATER|READ_LATER" app/src/main supabase/functions/llm_gateway`, then record intended Android and cloud classifier coverage in [specs/016-intent-set-migration/quickstart.md](../specs/016-intent-set-migration/quickstart.md).
- [x] T018 Confirm no ContactRef entity, Room migration, exported schema, or historical intent rewrite leaked into `/Users/richelgomez/dev/orbit-spec-016`; record the confirmation in [specs/016-intent-set-migration/tasks.md](../specs/016-intent-set-migration/tasks.md).
- [x] T019 Update or replace PR #8 from `/Users/richelgomez/dev/orbit-spec-016` only after T011 through T018 pass; include gate output and stale-PR reconciliation notes in the PR body linked from [docs/branch-debt-closeout-tasks-2026-05-13.md](branch-debt-closeout-tasks-2026-05-13.md).
...
**Independent Test**: The staged data/migration/repository changes in `/Users/richelgomez/dev/orbit-spec-017` are either committed into a reviewable PR or explicitly split/deferred without losing any staged file.

### Phase 3 Snapshot - 2026-05-13

Recorded from `/Users/richelgomez/dev/orbit-spec-017`. No staged files were unstaged, discarded, committed, rebased, or pushed.
...
- [x] T021 Confirm T020 is complete or explicitly deferred before mutating `/Users/richelgomez/dev/orbit-spec-017`; record the dependency state in [specs/017-capture-feedback-actions/tasks.md](../specs/017-capture-feedback-actions/tasks.md).
- [x] T022 Capture the staged file list in `/Users/richelgomez/dev/orbit-spec-017` with `git diff --staged --name-status` and copy the summary into [docs/branch-debt-closeout-tasks-2026-05-13.md](branch-debt-closeout-tasks-2026-05-13.md) before any commit or split.
- [x] T023 Capture the staged diff stat in `/Users/richelgomez/dev/orbit-spec-017` with `git diff --staged --stat` and copy the summary into [docs/branch-debt-closeout-tasks-2026-05-13.md](branch-debt-closeout-tasks-2026-05-13.md) before any commit or split.
...
- [x] T025 Stop and reroute any staged file in `/Users/richelgomez/dev/orbit-spec-017` that belongs to visual-only `015`, ContactRef `016` follow-up, or future `004` through `012` work; document reroutes in [docs/capture-overlay-followups.md](capture-overlay-followups.md).
- [x] T026 Commit or intentionally split the staged `017` files from `/Users/richelgomez/dev/orbit-spec-017` after T022 through T025 are recorded; do not use `git reset --hard`, `git clean`, or unstaged discard commands.
- [x] T027 Verify Room schema version, exported schema JSON, and migration naming in `/Users/richelgomez/dev/orbit-spec-017/app/schemas/com.orbit.app.data.OrbitDatabase` against [specs/017-capture-feedback-actions/data-model.md](../specs/017-capture-feedback-actions/data-model.md).
- [x] T028 Run the Android gate in `/Users/richelgomez/dev/orbit-spec-017`: `ANDROID_HOME="$HOME/Library/Android/sdk" JAVA_HOME='/Applications/Android Studio.app/Contents/jbr/Contents/Home' ./gradlew :app:compileDebugKotlin :app:testDebugUnitTest :app:compileDebugAndroidTestKotlin :app:lintDebug`, then record results in [specs/017-capture-feedback-actions/tasks.md](../specs/017-capture-feedback-actions/tasks.md).
- [x] T029 Run focused duplicate-capture tests in `/Users/richelgomez/dev/orbit-spec-017` for URL duplicate, exact-text duplicate, deleted/archived duplicate exclusions, note persistence, reclassify, open-existing, and URL hydration reuse; record command names and results in [specs/017-capture-feedback-actions/tasks.md](../specs/017-capture-feedback-actions/tasks.md).
- [x] T030 Confirm duplicate audit metadata in `/Users/richelgomez/dev/orbit-spec-017` includes `existingEnvelopeId` and `matchedBy` but not raw text or full URLs; record confirmation in [specs/017-capture-feedback-actions/tasks.md](../specs/017-capture-feedback-actions/tasks.md).
...
- [x] T032 Open, update, or land the `017-capture-feedback-actions` PR from `/Users/richelgomez/dev/orbit-spec-017` after T021 through T031 pass; record merge commit or defer reason in [docs/spec-branch-reorganization-plan-2026-05-13.md](spec-branch-reorganization-plan-2026-05-13.md).
...
**Independent Test**: The staged visual refit files in `/Users/richelgomez/dev/orbit-015-phase1-split` are committed or split safely, the remaining T015 verification gaps are either closed or deferred, and the stale PR #5 is closed or replaced.

### Phase 4 Snapshot - 2026-05-13

Recorded from `/Users/richelgomez/dev/orbit-015-phase1-split`. The worktree is on `015-phase1-cluster-surface`, ahead of `origin/main` by 17 commits, with no unstaged edits before closeout recording.
...
- [x] T033 Confirm T020 and T032 are complete or explicitly deferred before mutating `/Users/richelgomez/dev/orbit-015-phase1-split`; record the dependency state in [specs/015-visual-refit/tasks.md](../specs/015-visual-refit/tasks.md).
- [x] T034 Capture the staged file list in `/Users/richelgomez/dev/orbit-015-phase1-split` with `git diff --staged --name-status` and copy the summary into [docs/branch-debt-closeout-tasks-2026-05-13.md](branch-debt-closeout-tasks-2026-05-13.md) before any commit or split.
- [x] T035 Capture the staged diff stat in `/Users/richelgomez/dev/orbit-015-phase1-split` with `git diff --staged --stat` and copy the summary into [docs/branch-debt-closeout-tasks-2026-05-13.md](branch-debt-closeout-tasks-2026-05-13.md) before any commit or split.
...
- [x] T039 Commit or intentionally split the staged `015` files from `/Users/richelgomez/dev/orbit-015-phase1-split` after T034 through T038 are recorded; do not use `git reset --hard`, `git clean`, or unstaged discard commands.
- [x] T040 Run the Android gate in `/Users/richelgomez/dev/orbit-015-phase1-split`: `ANDROID_HOME="$HOME/Library/Android/sdk" JAVA_HOME='/Applications/Android Studio.app/Contents/jbr/Contents/Home' ./gradlew :app:compileDebugKotlin :app:testDebugUnitTest :app:compileDebugAndroidTestKotlin :app:lintDebug`, then record results in [specs/015-visual-refit/tasks.md](../specs/015-visual-refit/tasks.md).
- [x] T041 Run the build-logic lint gate in `/Users/richelgomez/dev/orbit-015-phase1-split`: `./gradlew :build-logic:lint:test`, then record results in [specs/015-visual-refit/tasks.md](../specs/015-visual-refit/tasks.md).
...
- [x] T046 Open, update, or land the `015-phase1-cluster-surface` PR from `/Users/richelgomez/dev/orbit-015-phase1-split` after T033 through T045 pass; record merge commit or defer reason in [docs/spec-branch-reorganization-plan-2026-05-13.md](spec-branch-reorganization-plan-2026-05-13.md).
...
- [ ] T047 Confirm T020, T032, and T046 are complete or explicitly deferred before creating `docs/product-truth-reset`; record the dependency state in [docs/spec-branch-reorganization-plan-2026-05-13.md](spec-branch-reorganization-plan-2026-05-13.md).
- [ ] T048 Create `docs/product-truth-reset` from a clean `main` worktree in `/Users/richelgomez/dev/orbit` or a dedicated docs worktree; record the chosen worktree path in [docs/branch-debt-closeout-tasks-2026-05-13.md](branch-debt-closeout-tasks-2026-05-13.md).
- [ ] T049 Move or commit the untracked planning docs from `/Users/richelgomez/dev/orbit/docs` together on `docs/product-truth-reset`, including [docs/spec-branch-reorganization-plan-2026-05-13.md](spec-branch-reorganization-plan-2026-05-13.md) and [docs/branch-debt-closeout-tasks-2026-05-13.md](branch-debt-closeout-tasks-2026-05-13.md).
- [ ] T050 Update [README.md](../README.md) so public product copy reflects local-first, cloud-augmented Orbit behavior without claiming local-only, no Orbit server, or BYOK/BYOC-first defaults.
- [ ] T051 Update any `.specify/memory` product docs under `/Users/richelgomez/dev/orbit/.specify` that still claim local-only, no Orbit server, or BYOK/BYOC-first defaults.
- [ ] T052 Archive stale spec-only folders [specs/004-ask-orbit](../specs/004-ask-orbit), [specs/005-cloud-boost-byok-llm](../specs/005-cloud-boost-byok-llm), [specs/006-orbit-cloud-storage](../specs/006-orbit-cloud-storage), [specs/007-knowledge-graph](../specs/007-knowledge-graph), [specs/008-orbit-agent](../specs/008-orbit-agent), [specs/009-byoc-sovereign-storage](../specs/009-byoc-sovereign-storage), [specs/010-visual-polish-pass](../specs/010-visual-polish-pass), [specs/011-manual-compose](../specs/011-manual-compose), and [specs/012-resolution-semantics](../specs/012-resolution-semantics) as legacy inputs, then recreate the active roadmap in those same numbers: `004-capture-understanding`, `005-retrieval-and-ask-citations`, `006-approval-action-runtime`, `007-memory-candidates-inspector`, `008-cloud-controls-storage-budgeting`, `009-kg-backend-poc`, `010-agent-coordinator`, `011-manual-compose`, and `012-resolution-semantics`. Status headers added on 2026-05-13 are a guardrail, not the final docs-reset archive step.
- [ ] T053 Reconcile stale task status in [specs/003-orbit-actions/tasks.md](../specs/003-orbit-actions/tasks.md) by verifying code reality before changing checkboxes; feed remaining action concepts into the future `006-approval-action-runtime` plan.
- [ ] T054 Reconcile stale task status in [specs/013-cloud-llm-routing/tasks.md](../specs/013-cloud-llm-routing/tasks.md) by verifying Android/provider/router and Supabase migration reality after PR #1 cloud-pivot.
- [ ] T055 Reconcile [specs/014-edge-function-llm-gateway/tasks.md](../specs/014-edge-function-llm-gateway/tasks.md) by adding status or follow-up notes for `supabase/functions/llm_gateway` without regenerating Day 2 from scratch.
- [ ] T056 Confirm `docs/product-truth-reset` changes are markdown/docs/spec status only by running `git -C /Users/richelgomez/dev/orbit diff --name-only origin/main...HEAD` and reviewing paths before PR.
...
- [ ] T058 Verify `/Users/richelgomez/dev/orbit`, `/Users/richelgomez/dev/orbit-spec-016`, `/Users/richelgomez/dev/orbit-spec-017`, and `/Users/richelgomez/dev/orbit-015-phase1-split` have no unexpected staged or untracked implementation work; record results in [docs/branch-debt-closeout-tasks-2026-05-13.md](branch-debt-closeout-tasks-2026-05-13.md).
...
- [ ] T062 Confirm no new `004` through `012` branch exists locally or remotely before T057 is complete by checking branch lists from `/Users/richelgomez/dev/orbit`; record results in [docs/branch-debt-closeout-tasks-2026-05-13.md](branch-debt-closeout-tasks-2026-05-13.md).
...
```bash
# Terminal A in /Users/richelgomez/dev/orbit-spec-016
ANDROID_HOME="$HOME/Library/Android/sdk" \
JAVA_HOME='/Applications/Android Studio.app/Contents/jbr/Contents/Home' \
./gradlew :app:compileDebugKotlin :app:testDebugUnitTest :app:compileDebugAndroidTestKotlin :app:lintDebug

# Terminal B in /Users/richelgomez/dev/orbit-spec-016/supabase/functions/llm_gateway
npm test

# Terminal C in /Users/richelgomez/dev/orbit-spec-016
