...
/**
 * Lint detector that prevents HTTP client usage outside `com.orbit.app.net.*`.
 *
    ...
    companion object {
        val ISSUE: Issue = Issue.create(
            ...
            explanation = """
                ...
                `com.orbit.app.net.*`. Move this code into the net package or use the \
        ...
        private const val ALLOWED_PACKAGE = "com.orbit.app.net"
    }
