...
class NoAgentVoiceMarkOutsideAgentSurfacesDetectorTest : LintDetectorTest() {
    ...
    fun testAgentVoiceMarkInClusterSuggestionCard_allowed() {
        lint().files(
            kotlin(
                "src/com/orbit/app/diary/ui/ClusterSuggestionCard.kt",
                """
    ...
    fun testAgentVoiceMarkInRandomComposable_flagged() {
        lint().files(
            kotlin(
                "src/com/orbit/app/diary/ui/EnvelopeRow.kt",
                """
                package com.orbit.app.diary.ui
            ...
            .expect(
                """
                src/com/orbit/app/diary/ui/EnvelopeRow.kt:6: Error: AgentVoiceMark called from EnvelopeRow.kt — not on the agent-voice surface allow-list. See spec 010 FR-010-019. [OrbitNoAgentVoiceMarkOutsideAgentSurfaces]
                    AgentVoiceMark()
                    ~~~~~~~~~~~~~~~~
                1 errors, 0 warnings
                """.trimIndent()
    ...
    fun testAgentVoiceMarkInsideOwnFile_allowed() {
        ...
        lint().files(
            kotlin(
                "src/com/orbit/app/ui/primitives/AgentVoiceMark.kt",
                """
