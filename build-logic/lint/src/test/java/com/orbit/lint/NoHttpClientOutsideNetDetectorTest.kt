 ...
 *
 * Verifies Principle VI enforcement: HTTP clients outside com.orbit.app.net
...
class NoHttpClientOutsideNetDetectorTest : LintDetectorTest() {
    ...
    fun testOkHttpClientInCapturePackage_flagged() {
        lint().files(
            ...
            .expect(
                """
                src/com/orbit/app/capture/BadCapture.kt:6: Error: HTTP client okhttp3.OkHttpClient used outside com.orbit.app.net. Use INetworkGateway AIDL to request network I/O. [OrbitNoHttpClientOutsideNet]
                    val client = OkHttpClient()
                                 ~~~~~~~~~~~~~~
                1 errors, 0 warnings
                """.trimIndent()
    ...
    fun testSocketInUiPackage_flagged() {
        lint().files(
            ...
            .expect(
                """
                src/com/orbit/app/ui/Leaky.kt:7: Error: HTTP client java.net.Socket used outside com.orbit.app.net. Use INetworkGateway AIDL to request network I/O. [OrbitNoHttpClientOutsideNet]
                        val s = Socket("example.com", 443)
                                ~~~~~~~~~~~~~~~~~~~~~~~~~~
                1 errors, 0 warnings
                """.trimIndent()
     ...
     * `com.orbit.app.action.handler.*`; an OkHttp leak there would let a
    ...
    fun testOkHttpInActionHandlerPackage_flagged() {
        lint().files(
            kotlin(
                """
                package com.orbit.app.action.handler
            ...
            .expect(
                """
                src/com/orbit/app/action/handler/CalendarActionHandler.kt:6: Error: HTTP client okhttp3.OkHttpClient used outside com.orbit.app.net. Use INetworkGateway AIDL to request network I/O. [OrbitNoHttpClientOutsideNet]
                    private val client = OkHttpClient()
                                         ~~~~~~~~~~~~~~
                1 errors, 0 warnings
                """.trimIndent()
    ...
    fun testSocketInActionPackage_flagged() {
        lint().files(
            ...
            .expect(
                """
                src/com/orbit/app/action/ActionExecutorService.kt:7: Error: HTTP client java.net.Socket used outside com.orbit.app.net. Use INetworkGateway AIDL to request network I/O. [OrbitNoHttpClientOutsideNet]
                        val s = Socket("example.com", 443)
                                ~~~~~~~~~~~~~~~~~~~~~~~~~~
                1 errors, 0 warnings
                """.trimIndent()
