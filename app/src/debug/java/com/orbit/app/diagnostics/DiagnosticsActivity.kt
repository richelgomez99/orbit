package com.orbit.app.diagnostics
...
import com.orbit.app.ai.LlmProviderDiagnostics
 ...
 * [com.orbit.app.ai.NanoUnavailableException] without de-provisioning AICore
...
class DiagnosticsActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val title = TextView(this).apply {
            text = "Orbit diagnostics (debug only)"
            textSize = 18f
            setPadding(0, 0, 0, 32)
        }
