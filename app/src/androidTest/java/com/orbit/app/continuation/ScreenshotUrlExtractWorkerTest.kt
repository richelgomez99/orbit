...
import com.orbit.app.ai.OcrEngine
...
class ScreenshotUrlExtractWorkerTest {
    ...
    private class RecordingRepository : IEnvelopeRepository.Stub() {
        ...
        override fun searchLocalEnvelopes(query: String, limit: Int): MutableList<EnvelopeViewParcel> = mutableListOf()
        ...
        override fun syncMemoryIndex(envelopeId: String, mode: String, reason: String?): String = "SKIPPED"
