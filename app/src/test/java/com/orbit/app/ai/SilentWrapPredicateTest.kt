...
import com.orbit.app.data.EnvelopeStorageBackend
...
class SilentWrapPredicateTest {
    ...
    private class FakeBackend(private val priorExists: Boolean) : EnvelopeStorageBackend {
        ...
        override fun observeDayWithResults(dayLocal: String): Flow<List<com.orbit.app.data.entity.IntentEnvelopeWithResults>> = emptyFlow()
