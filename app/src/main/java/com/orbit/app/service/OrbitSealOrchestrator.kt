...
import com.orbit.app.ai.IntentPredictor
import com.orbit.app.ai.LlmProviderRouter
import com.orbit.app.capture.SensitivityScrubber
...
import com.orbit.app.overlay.SealOrchestrator
import com.orbit.app.overlay.SealOutcome
import com.orbit.app.overlay.UndoOutcome
 ...
 *   4. Silent-wrap gate — mirrors [com.orbit.app.ai.SilentWrapPredicate]'s
...
class OrbitSealOrchestrator(
    ...
    private fun IEnvelopeRepository.sealResultSafe(
        ...
        state: com.orbit.app.data.ipc.StateSnapshotParcel
    ...
    companion object {
        private const val TAG = "OrbitSealOrch"
