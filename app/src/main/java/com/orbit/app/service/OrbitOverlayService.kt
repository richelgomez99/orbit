...
import com.orbit.app.overlay.BubbleUI
import com.orbit.app.overlay.CaptureSheetUI
import com.orbit.app.overlay.DismissTargetMetrics
import com.orbit.app.overlay.DismissTargetUI
import com.orbit.app.overlay.EdgeSide
import com.orbit.app.overlay.ExpansionState
import com.orbit.app.overlay.OverlayViewModel
import com.orbit.app.overlay.PostCaptureOverlay
import com.orbit.app.overlay.PostCaptureUi
import com.orbit.app.capture.StateSnapshotCollector
import com.orbit.app.capture.ScreenshotObserver
...
class OrbitOverlayService : LifecycleService() {
    ...
    private var sealOrchestrator: OrbitSealOrchestrator? = null
    ...
    private fun setupOverlay() {
        ...
        val orchestrator = OrbitSealOrchestrator(
    ...
    private fun syncCollapsedOverlayPosition(
        ...
        bubbleState: com.orbit.app.overlay.BubbleState
    ) {
        if (bubbleState.expansion != ExpansionState.COLLAPSED) {
            return
        }
