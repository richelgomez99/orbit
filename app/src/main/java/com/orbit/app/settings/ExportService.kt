...
object ExportService {
    ...
    private fun readme(ne: Int, nc: Int, nr: Int, na: Int): String = """
        ...
        |
        |## Schema stability
        |Fields mirror the Room entities 1:1 (see `com.orbit.app.data.entity.*`). Column names may change in future versions; re-running the export is the source of truth.
    """.trimMargin()
