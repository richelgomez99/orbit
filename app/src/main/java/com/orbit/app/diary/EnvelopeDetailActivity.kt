...
import com.orbit.app.diary.ui.EnvelopeDetailScreen
...
/**
 * T055b — host for [EnvelopeDetailScreen]. Launched from [com.orbit.app.diary.ui.EnvelopeCard]
...
class EnvelopeDetailActivity : ComponentActivity() {
    ...
    companion object {
        const val EXTRA_ENVELOPE_ID = "com.orbit.app.extra.ENVELOPE_ID"
        const val EXTRA_DAY_LOCAL = "com.orbit.app.extra.DAY_LOCAL"
        const val EXTRA_START_NOTE = "com.orbit.app.extra.START_NOTE"

        /** Convenience builder used by [com.orbit.app.diary.ui.EnvelopeCard]. */
        fun newIntent(
