...
import com.orbit.app.audit.AuditLogRetentionWorker
import com.orbit.app.audit.DebugDumpReceiver
import com.orbit.app.continuation.SoftDeleteRetentionWorker
...
class OrbitApplication : Application(), Configuration.Provider {
    ...
    private fun registerBuiltInAppFunctions() {
        ...
        scope.launch {
            try {
                val db = OrbitDatabase.getInstance(this@OrbitApplication)
                ...
                registry.registerAll(com.orbit.app.action.BuiltInAppFunctionSchemas.ALL)
            } catch (t: Throwable) {
                Log.e("OrbitApplication", "AppFunctionRegistry boot failed", t)
            }
        }
    }
    ...
    private fun scheduleWeeklyDigest() {
        ...
        val request = PeriodicWorkRequestBuilder<com.orbit.app.continuation.WeeklyDigestWorker>(
            repeatInterval = 7,
            repeatIntervalTimeUnit = TimeUnit.DAYS,
            flexTimeInterval = 4,
            ...
            .build()
        WorkManager.getInstance(this).enqueueUniquePeriodicWork(
            com.orbit.app.continuation.WeeklyDigestWorker.UNIQUE_WORK_NAME,
            ExistingPeriodicWorkPolicy.KEEP,
            request
        )
    }
    ...
    private fun scheduleClusterDetection() {
        ...
        val request = PeriodicWorkRequestBuilder<com.orbit.app.cluster.ClusterDetectionWorker>(
            repeatInterval = 1,
            repeatIntervalTimeUnit = TimeUnit.DAYS,
            flexTimeInterval = 2,
            flexTimeIntervalUnit = TimeUnit.HOURS
            ...
            .build()
        WorkManager.getInstance(this).enqueueUniquePeriodicWork(
            com.orbit.app.cluster.ClusterDetectionWorker.UNIQUE_WORK_NAME,
            ExistingPeriodicWorkPolicy.KEEP,
            request
        )
    }
