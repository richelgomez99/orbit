...
/**
 * AIDL-carried view of an [com.orbit.app.data.entity.AppFunctionSkillEntity].
 *
...
data class AppFunctionSummaryParcel(
    ...
    /** [com.orbit.app.data.model.AppFunctionSideEffect].name */
    val sideEffects: String,
    /** [com.orbit.app.data.model.Reversibility].name */
    val reversibility: String,
    /** [com.orbit.app.data.model.SensitivityScope].name */
