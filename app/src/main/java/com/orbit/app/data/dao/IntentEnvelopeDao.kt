...
interface IntentEnvelopeDao {
    ...
    /**
     * Day view enriched with every [com.orbit.app.data.entity.ContinuationResultEntity]
     ...
     * [com.orbit.app.data.entity.ContinuationResultEntity] at the same
    ...
    /**
     * T074 / 003 US3 — input window for [com.orbit.app.ai.DigestComposer].
