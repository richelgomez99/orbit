...
/**
 * AIDL-carried view of an [com.orbit.app.data.entity.ActionProposalEntity].
 *
...
data class ActionProposalParcel(
    ...
    /** Mirrors [com.orbit.app.data.model.LlmProvenance].name */
    val provenance: String,
    /** Mirrors [com.orbit.app.data.model.ActionProposalState].name */
    val state: String,
    /** Mirrors [com.orbit.app.data.model.SensitivityScope].name */
