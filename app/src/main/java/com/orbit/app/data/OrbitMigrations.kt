...
/** v8 — spec 004 Capture Understanding: understanding results, evidence bundles, invalidation records, correction feedback. */
...
/** v9 — spec 004 Active Intent cleanup sidecar rows. */
internal val MIGRATION_8_9: Migration = object : Migration(8, 9) {
    override fun migrate(db: SupportSQLiteDatabase) {
        ...
        db.execSQL("CREATE INDEX IF NOT EXISTS index_active_intent_status_intentType ON active_intent(status, intentType)")
