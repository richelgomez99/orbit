...
enum class AuditAction {
    ...
    // --- Spec 004: Capture Understanding ---
    /** User requested escalation from BASIC → SMART or SMART → DEEP understanding. */
    UNDERSTANDING_ESCALATION_REQUESTED,
    /** Understanding result tombstoned via [com.orbit.app.understanding.engine.InvalidationService]. */
