...
class ContinuationEngine(
     ...
     * binder (see [com.orbit.app.data.ipc.IEnvelopeRepository.seedScreenshotHydrations]).
     */
     ...
     *  1. Run the [com.orbit.app.ai.extract.ActionExtractionPrefilter]
    ...
    fun enqueueActionExtract(envelopeId: String) {
        ...
        if (privacyPreferences?.continuationsPaused == true) return
        val request = OneTimeWorkRequestBuilder<com.orbit.app.ai.extract.ActionExtractionWorker>()
    ...
    companion object {
         ...
         * ([com.orbit.app.continuation.ContinuationEngineTest]).
