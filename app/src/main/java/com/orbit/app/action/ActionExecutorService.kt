 ...
 *
 * Constraints:
 *  - MUST NOT depend on any class from `com.orbit.app.net.*` (lint-enforced)
...
class ActionExecutorService : Service() {
    ...
    override fun onCreate() {
        ...
        val intent = Intent().apply {
            setClassName(packageName, "com.orbit.app.data.ipc.EnvelopeRepositoryService")
        }
    ...
    companion object {
        ...
        const val ACTION_BIND_EXECUTOR = "com.orbit.app.action.BIND_ACTION_EXECUTOR"
