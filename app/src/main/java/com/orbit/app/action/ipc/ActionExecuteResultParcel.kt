...
/**
 * Synchronous response from [com.orbit.app.action.ipc.IActionExecutor.execute].
 *
 * - [outcome] mirrors [com.orbit.app.data.model.ActionExecutionOutcome] `.name`.
 ...
 * - [executionId] is the UUID of the persisted [com.orbit.app.data.entity.ActionExecutionEntity]
