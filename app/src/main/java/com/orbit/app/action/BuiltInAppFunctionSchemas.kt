...
import com.orbit.app.data.model.AppFunctionSideEffect
import com.orbit.app.data.model.Reversibility
 ...
 * with the actual handler implementations under `com.orbit.app.action.handler`.
 *
...
object BuiltInAppFunctionSchemas {
    ...
    private const val ORBIT_PKG = "com.orbit.app"
