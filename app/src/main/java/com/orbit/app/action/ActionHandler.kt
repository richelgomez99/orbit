 ...
 * [com.orbit.app.data.model.ActionExecutionOutcome] but adds a
...
/**
 * Pure SAM-style handler for one [com.orbit.app.action.AppFunction].
 *
 * Lives in the `:capture` process. MUST NOT touch the network and MUST
 * NOT bind any class from `com.orbit.app.net.*` (enforced by the
