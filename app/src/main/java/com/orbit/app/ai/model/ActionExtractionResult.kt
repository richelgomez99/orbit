...
/**
 * Lightweight projection of an [com.orbit.app.data.entity.AppFunctionSkillEntity] passed to
 * [com.orbit.app.ai.LlmProvider.extractActions]. The provider never sees the registry's
...
/**
 * Result of an [com.orbit.app.ai.LlmProvider.extractActions] call.
 *
