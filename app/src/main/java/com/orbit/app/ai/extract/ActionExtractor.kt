package com.orbit.app.ai.extract
...
import com.orbit.app.data.model.toEntityEnum
 ...
 *  3. Resolve registered functions filtered by appPackage="com.orbit.app".
...
class ActionExtractor(
    ...
    suspend fun extract(envelopeId: String): ExtractOutcome {
        ...
        val skills = registry.listForApp("com.orbit.app")
