 ...
 *     (cloud-by-default; local Nano under [com.orbit.app.RuntimeFlags.useLocalAi]),
 ...
 * [com.orbit.app.data.dao.ClusterDao.findClusterCandidates], which
...
class ClusterDetectionWorker(
    ...
    companion object {
         ...
         * [com.orbit.app.RuntimeFlags.useLocalAi].
         */
        @Volatile
         ...
         * uses (see [com.orbit.app.continuation.UrlHydrateWorker]).
         */
        @Volatile
