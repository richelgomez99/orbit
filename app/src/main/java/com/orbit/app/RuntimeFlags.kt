...
import com.orbit.app.ai.NanoLlmProvider
 ...
 * mirrors the [com.orbit.app.ai.LlmProviderDiagnostics] convention
...
object RuntimeFlags {
     ...
     *
        * Default `true` for the current Orbit alpha line. The composition root
        * reads this once into `LocalRuntimeFlags`; production code MUST NOT
        * observe it reactively.
     */
    @Volatile
    @JvmStatic
    var useNewVisualLanguage: Boolean = true
        internal set
}
