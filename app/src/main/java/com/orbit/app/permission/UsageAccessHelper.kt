package com.orbit.app.permission
 ...
 *
 * Without this permission, [com.orbit.app.capture.StateSnapshotCollector]
 * falls back to [com.orbit.app.data.model.AppCategory.UNKNOWN_SOURCE] and
