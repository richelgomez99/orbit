...
When a `v*` tag is pushed, the workflow attaches `orbit-debug.apk` to a GitHub Release at `https://github.com/richelgomez99/orbit/releases/tag/<tag>`. From Linux:
...
Get the URL of the latest `orbit-debug.apk` from the [Releases page](https://github.com/richelgomez99/orbit/releases). Then:
